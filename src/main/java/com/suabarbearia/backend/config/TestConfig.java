...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Barbershops
		Barbershop b1 = new Barbershop(null, "Moreira Cortes", "moreirabarber@email.com", null, "123 Main Street");
		Barbershop b2 = new Barbershop(null, "Oliveira Barbearia", "oliveirabarber@email.com", null, "500 Main Street");
		Barbershop b3 = new Barbershop(null, "Ze Lucas", "zelucas@email.com", null, "10 Main Street");
