...
export function EmployeeBarbershopEdit() {
    ...
    const { authenticatedBarbershop, EmployeeBarbershopEdit } = useContext(Context);
    const { id } = useParams();
    ...
    function handleSubmit(e) {
        ...
        EmployeeBarbershopEdit(employee, employee.id);
    };
    ...
    return (
        <section className="container container-form">
            ...
            ? (
                <>
                    <h1 className="title">Atualize os dados do funcionário!</h1>
